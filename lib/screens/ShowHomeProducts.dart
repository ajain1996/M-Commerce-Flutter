import 'package:Gauth/screens/tabs/show_comment.dart';
...
import 'package:Gauth/widgets/comment_input.dart';
...
class ShowHomeProducts extends StatefulWidget {
  ...
  ShowHomeProducts({this.productId});
                  ...
                  child: ListView(
                    ...
                    children: [
                      Container(
                        child: Image.network(
                          "${documentData['image']}" ??
                              'https://images.unsplash.com/photo-1583021387258-225db94c655d?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8bm8lMjBpbWFnZSUyMGhlcmV8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
                          // fit: BoxFit.cover,
                          height: 320.0,
                        ),
                      ),
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "${documentData['rating']}" ?? 'Product Rating',
